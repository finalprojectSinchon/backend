    ...
    public static class Response {
        ...
        public static class Body {
            ...
            public static class Item {
                ...
                @Schema(description = "예정 도착 시간", example = "2024-07-26T12:34:56")
                private String scheduleDateTime;
                @Schema(description = "예상 도착 시간", example = "2024-07-26T12:45:00")
